...
namespace Eco.Mods.TechTree
{
    ...
    public class SteamTractorRecipe : RecipeFamily
    {
        public SteamTractorRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(1000, typeof(MechanicsSkill), typeof(SteamTractorRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteamTractorRecipe), this.UILink(), 10, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));    
