...
namespace Eco.Mods.TechTree
{
    ...
    public class WheelbarrowRecipe : RecipeFamily
    {
        public WheelbarrowRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(75, typeof(CarpentrySkill), typeof(WheelbarrowRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WheelbarrowRecipe), this.UILink(), 2, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));    
