...
namespace Eco.Mods.TechTree
{
    ...
    public class SkidSteerRecipe : RecipeFamily
    {
        public SkidSteerRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(2500, typeof(IndustrySkill), typeof(SkidSteerRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SkidSteerRecipe), this.UILink(), 10, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));    
