...
namespace Eco.Mods.TechTree
{
    ...
    public class PoweredCartRecipe : RecipeFamily
    {
        public PoweredCartRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(PoweredCartRecipe), 10, typeof(BasicEngineeringSkill), typeof(BasicEngineeringFocusedSpeedTalent), typeof(BasicEngineeringParallelSpeedTalent));    
