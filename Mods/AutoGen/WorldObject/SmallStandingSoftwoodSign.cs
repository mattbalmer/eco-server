...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SmallStandingSoftwoodSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Small Standing Softwood Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(SmallStandingSoftwoodSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static SmallStandingSoftwoodSignItem()
        {
    ...
    public partial class SmallStandingSoftwoodSignRecipe :
        Recipe
    {
        public SmallStandingSoftwoodSignRecipe()
        {
            var product = new Recipe(
                "SmallStandingSoftwoodSign",
                Localizer.DoStr("Small Standing Softwood Sign"),
               ...
               new IngredientElement("Softwood", 5, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)),    
                },
