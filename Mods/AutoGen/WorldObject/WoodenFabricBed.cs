...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public WoodenFabricBedRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(CarpentrySkill), typeof(WoodenFabricBedRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WoodenFabricBedRecipe), this.UILink(), 6, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Wooden Fabric Bed"), typeof(WoodenFabricBedRecipe));
