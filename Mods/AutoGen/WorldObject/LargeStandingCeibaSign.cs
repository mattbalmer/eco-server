...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeStandingCeibaSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Large Standing Ceiba Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(LargeStandingCeibaSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static LargeStandingCeibaSignItem()
        {
    ...
    public partial class LargeStandingCeibaSignRecipe :
        Recipe
    {
        public LargeStandingCeibaSignRecipe()
        {
            var product = new Recipe(
                "LargeStandingCeibaSign",
                Localizer.DoStr("Large Standing Ceiba Sign"),
