...
typeof(SmeltingUpgradeItem), })]  
        ...
        RecipeFamily
    {
        public BlastFurnaceRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(1000, typeof(SmeltingSkill), typeof(BlastFurnaceRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(BlastFurnaceRecipe), this.UILink(), 25, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Blast Furnace"), typeof(BlastFurnaceRecipe));
