...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelCeilingLightRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(ElectronicsSkill), typeof(SteelCeilingLightRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelCeilingLightRecipe), this.UILink(), 4, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Steel Ceiling Light"), typeof(SteelCeilingLightRecipe));
