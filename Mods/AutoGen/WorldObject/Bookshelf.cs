...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public BookshelfRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(CarpentrySkill), typeof(BookshelfRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(BookshelfRecipe), this.UILink(), 2, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Bookshelf"), typeof(BookshelfRecipe));
