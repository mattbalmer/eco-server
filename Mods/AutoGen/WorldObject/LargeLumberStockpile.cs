...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LargeLumberStockpileRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(2000, typeof(CarpentrySkill), typeof(LargeLumberStockpileRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LargeLumberStockpileRecipe), this.UILink(), 12, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Large Lumber Stockpile"), typeof(LargeLumberStockpileRecipe));
