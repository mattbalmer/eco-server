...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public DistributionStationRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(DistributionStationRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(DistributionStationRecipe), this.UILink(), 2, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Distribution Station"), typeof(DistributionStationRecipe));
