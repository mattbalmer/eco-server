...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public MortaredStoneDoorRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(20, typeof(MasonrySkill), typeof(MortaredStoneDoorRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(MortaredStoneDoorRecipe), this.UILink(), 1, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Mortared Stone Door"), typeof(MortaredStoneDoorRecipe));
