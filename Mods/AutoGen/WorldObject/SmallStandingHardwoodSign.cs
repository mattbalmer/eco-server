...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SmallStandingHardwoodSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Small Standing Hardwood Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(SmallStandingHardwoodSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static SmallStandingHardwoodSignItem()
        {
    ...
    public partial class SmallStandingHardwoodSignRecipe :
        Recipe
    {
        public SmallStandingHardwoodSignRecipe()
        {
            var product = new Recipe(
                "SmallStandingHardwoodSign",
                Localizer.DoStr("Small Standing Hardwood Sign"),
