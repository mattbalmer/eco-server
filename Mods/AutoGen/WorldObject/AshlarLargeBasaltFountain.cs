...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AshlarLargeBasaltFountainObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Ashlar Large Basalt Fountain"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(AshlarLargeBasaltFountainItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(AshlarLargeBasaltFountainItem.HousingVal);                               
    ...
    public partial class AshlarLargeBasaltFountainItem :
        WorldObjectItem<AshlarLargeBasaltFountainObject> 
    {
        ...
        static AshlarLargeBasaltFountainItem()
        {
    ...
    public partial class AshlarLargeBasaltFountainRecipe :
        Recipe
    {
        public AshlarLargeBasaltFountainRecipe()
        {
            var product = new Recipe(
                "AshlarLargeBasaltFountain",
                Localizer.DoStr("Ashlar Large Basalt Fountain"),
