...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public WashingMachineRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(400, typeof(IndustrySkill), typeof(WashingMachineRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WashingMachineRecipe), this.UILink(), 10, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Washing Machine"), typeof(WashingMachineRecipe));
