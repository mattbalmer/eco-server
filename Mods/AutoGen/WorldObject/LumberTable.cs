...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LumberTableRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(LumberTableRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LumberTableRecipe), this.UILink(), 4, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Lumber Table"), typeof(LumberTableRecipe));
