...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeHangingBirchSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Large Hanging Birch Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(LargeHangingBirchSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static LargeHangingBirchSignItem()
        {
    ...
    public partial class LargeHangingBirchSignRecipe :
        Recipe
    {
        public LargeHangingBirchSignRecipe()
        {
            var product = new Recipe(
                "LargeHangingBirchSign",
                Localizer.DoStr("Large Hanging Birch Sign"),
