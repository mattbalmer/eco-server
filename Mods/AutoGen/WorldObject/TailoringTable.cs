...
namespace Eco.Mods.TechTree
{
        ...
        IRepresentsItem
    {
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(TailoringTableItem.HousingVal);                               
    ...
    [AllowPluginModules(Tags = new[] { "BasicUpgrade", }, ItemTypes = new[] { typeof(TailoringUpgradeItem), })]  
    ...
    public partial class TailoringTableRecipe :
        RecipeFamily
    {
        public TailoringTableRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(600, typeof(CarpentrySkill), typeof(TailoringTableRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(TailoringTableRecipe), this.UILink(), 25, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Tailoring Table"), typeof(TailoringTableRecipe));
