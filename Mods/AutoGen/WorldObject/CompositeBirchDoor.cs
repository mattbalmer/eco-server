...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositeBirchDoorObject : 
        DoorObject, 
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Composite Birch Door"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public override Type RepresentedItemType { get { return typeof(CompositeBirchDoorItem); } } 
    ...
    public partial class CompositeBirchDoorRecipe :
        Recipe
    {
        public CompositeBirchDoorRecipe()
        {
            var product = new Recipe(
                "CompositeBirchDoor",
                Localizer.DoStr("Composite Birch Door"),
                new IngredientElement[]
                {
               new IngredientElement(typeof(CompositeBirchLumberItem), 2, typeof(CompositesSkill), typeof(CompositesLavishResourcesTalent)), 
