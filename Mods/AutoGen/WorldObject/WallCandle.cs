...
namespace Eco.Mods.TechTree
{
    ...
    public partial class WallCandleRecipe :
        RecipeFamily
    {
        public WallCandleRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(80, typeof(SmeltingSkill), typeof(WallCandleRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WallCandleRecipe), this.UILink(), 3, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Wall Candle"), typeof(WallCandleRecipe));
