...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SmallHangingBirchSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Small Hanging Birch Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(SmallHangingBirchSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static SmallHangingBirchSignItem()
        {
    ...
    public partial class SmallHangingBirchSignRecipe :
        Recipe
    {
        public SmallHangingBirchSignRecipe()
        {
            var product = new Recipe(
                "SmallHangingBirchSign",
