...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AdornedAshlarStoneBenchObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Adorned Ashlar Stone Bench"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(AdornedAshlarStoneBenchItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(AdornedAshlarStoneBenchItem.HousingVal);                               
    ...
    public partial class AdornedAshlarStoneBenchRecipe :
        RecipeFamily
    {
        public AdornedAshlarStoneBenchRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(400, typeof(AdvancedMasonrySkill), typeof(AdornedAshlarStoneBenchRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(AdornedAshlarStoneBenchRecipe), this.UILink(), 8, typeof(AdvancedMasonrySkill), typeof(AdvancedMasonryFocusedSpeedTalent), typeof(AdvancedMasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Adorned Ashlar Stone Bench"), typeof(AdornedAshlarStoneBenchRecipe));
