...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public RollingMillRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(600, typeof(MechanicsSkill), typeof(RollingMillRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(RollingMillRecipe), this.UILink(), 20, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Rolling Mill"), typeof(RollingMillRecipe));
