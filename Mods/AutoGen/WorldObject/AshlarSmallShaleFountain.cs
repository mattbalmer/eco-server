...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AshlarSmallShaleFountainObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Ashlar Small Shale Fountain"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(AshlarSmallShaleFountainItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(AshlarSmallShaleFountainItem.HousingVal);                               
    ...
    public partial class AshlarSmallShaleFountainItem :
        WorldObjectItem<AshlarSmallShaleFountainObject> 
    {
        ...
        static AshlarSmallShaleFountainItem()
        {
    ...
    public partial class AshlarSmallShaleFountainRecipe :
        Recipe
    {
        public AshlarSmallShaleFountainRecipe()
        {
            var product = new Recipe(
                "AshlarSmallShaleFountain",
                Localizer.DoStr("Ashlar Small Shale Fountain"),
