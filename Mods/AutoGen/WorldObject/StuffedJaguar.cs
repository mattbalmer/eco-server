...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public StuffedJaguarRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(TailoringSkill), typeof(StuffedJaguarRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(StuffedJaguarRecipe), this.UILink(), 12, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Stuffed Jaguar"), typeof(StuffedJaguarRecipe));
