...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteamEngineRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(750, typeof(MechanicsSkill), typeof(SteamEngineRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteamEngineRecipe), this.UILink(), 10, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Steam Engine"), typeof(SteamEngineRecipe));
