        ...
        RecipeFamily
    {
        public ButcheryTableRecipe()
        {
            var product = new Recipe(
               ...
               new IngredientElement("Wood", 15, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)),    
                },
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(CarpentrySkill), typeof(ButcheryTableRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ButcheryTableRecipe), this.UILink(), 2, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Butchery Table"), typeof(ButcheryTableRecipe));
