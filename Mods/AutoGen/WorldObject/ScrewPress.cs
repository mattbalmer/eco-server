...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ScrewPressRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(MechanicsSkill), typeof(ScrewPressRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ScrewPressRecipe), this.UILink(), 5, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Screw Press"), typeof(ScrewPressRecipe));
