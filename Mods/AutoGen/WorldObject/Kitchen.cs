...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public KitchenRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(CarpentrySkill), typeof(KitchenRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(KitchenRecipe), this.UILink(), 10, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Kitchen"), typeof(KitchenRecipe));
