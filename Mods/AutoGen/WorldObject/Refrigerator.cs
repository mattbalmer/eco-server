...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public RefrigeratorRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(IndustrySkill), typeof(RefrigeratorRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(RefrigeratorRecipe), this.UILink(), 10, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Refrigerator"), typeof(RefrigeratorRecipe));
