...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ShelfCabinetRecipe :
        RecipeFamily
    {
        public ShelfCabinetRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(ShelfCabinetRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ShelfCabinetRecipe), this.UILink(), 2, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Shelf Cabinet"), typeof(ShelfCabinetRecipe));
