...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ToiletRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(PotterySkill), typeof(ToiletRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ToiletRecipe), this.UILink(), 4, typeof(PotterySkill), typeof(PotteryFocusedSpeedTalent), typeof(PotteryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Toilet"), typeof(ToiletRecipe));
