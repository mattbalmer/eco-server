...
typeof(AdvancedSmeltingUpgradeItem), })]  
        ...
        RecipeFamily
    {
        public AnvilRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(SmeltingSkill), typeof(AnvilRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(AnvilRecipe), this.UILink(), 8, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Anvil"), typeof(AnvilRecipe));
