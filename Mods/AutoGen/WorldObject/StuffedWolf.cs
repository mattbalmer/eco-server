...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public StuffedWolfRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(TailoringSkill), typeof(StuffedWolfRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(StuffedWolfRecipe), this.UILink(), 12, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Stuffed Wolf"), typeof(StuffedWolfRecipe));
