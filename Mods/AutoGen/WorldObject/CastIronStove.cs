...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CastIronStoveRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(SmeltingSkill), typeof(CastIronStoveRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CastIronStoveRecipe), this.UILink(), 6, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Cast Iron Stove"), typeof(CastIronStoveRecipe));
