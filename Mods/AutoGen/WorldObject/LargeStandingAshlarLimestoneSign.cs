...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeStandingAshlarLimestoneSignObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Large Standing Ashlar Limestone Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(LargeStandingAshlarLimestoneSignItem); } } 
    ...
    public partial class LargeStandingAshlarLimestoneSignRecipe :
        Recipe
    {
        public LargeStandingAshlarLimestoneSignRecipe()
        {
            var product = new Recipe(
                "LargeStandingAshlarLimestoneSign",
                Localizer.DoStr("Large Standing Ashlar Limestone Sign"),
