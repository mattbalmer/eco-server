...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeHangingSpruceSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Large Hanging Spruce Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(LargeHangingSpruceSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static LargeHangingSpruceSignItem()
        {
    ...
    public partial class LargeHangingSpruceSignRecipe :
        Recipe
    {
        public LargeHangingSpruceSignRecipe()
        {
            var product = new Recipe(
                "LargeHangingSpruceSign",
                Localizer.DoStr("Large Hanging Spruce Sign"),
