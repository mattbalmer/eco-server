...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CandleStandRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(SmeltingSkill), typeof(CandleStandRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CandleStandRecipe), this.UILink(), 4, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Candle Stand"), typeof(CandleStandRecipe));
