...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SmallStandingCedarSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Small Standing Cedar Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(SmallStandingCedarSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static SmallStandingCedarSignItem()
        {
    ...
    public partial class SmallStandingCedarSignRecipe :
        Recipe
    {
        public SmallStandingCedarSignRecipe()
        {
            var product = new Recipe(
                "SmallStandingCedarSign",
