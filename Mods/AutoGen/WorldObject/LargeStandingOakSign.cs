...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeStandingOakSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Large Standing Oak Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(LargeStandingOakSignItem); } } 
    ...
    public partial class LargeStandingOakSignRecipe :
        Recipe
    {
        public LargeStandingOakSignRecipe()
        {
            var product = new Recipe(
                "LargeStandingOakSign",
                Localizer.DoStr("Large Standing Oak Sign"),
