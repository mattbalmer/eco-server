...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RegistrarObject : 
        WorldObject,    
        IRepresentsItem
    {
        ...
        public virtual Type RepresentedItemType { get { return typeof(RegistrarItem); } } 
    ...
    public partial class RegistrarRecipe :
        RecipeFamily
    {
        public RegistrarRecipe()
        {
            var product = new Recipe(
               ...
               new IngredientElement("Lumber", 16, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)), 
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(CarpentrySkill), typeof(RegistrarRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(RegistrarRecipe), this.UILink(), 25, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Registrar"), typeof(RegistrarRecipe));
