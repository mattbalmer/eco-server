...
typeof(OilDrillingUpgradeItem), })]  
        ...
        RecipeFamily
    {
        public ElectricMachinistTableRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(600, typeof(IndustrySkill), typeof(ElectricMachinistTableRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ElectricMachinistTableRecipe), this.UILink(), 8, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Electric Machinist Table"), typeof(ElectricMachinistTableRecipe));
