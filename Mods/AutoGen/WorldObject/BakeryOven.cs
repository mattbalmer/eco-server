...
typeof(MasonryAdvancedUpgradeItem), })]  
        ...
        RecipeFamily
    {
        public BakeryOvenRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(PotterySkill), typeof(BakeryOvenRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(BakeryOvenRecipe), this.UILink(), 8, typeof(PotterySkill), typeof(PotteryFocusedSpeedTalent), typeof(PotteryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Bakery Oven"), typeof(BakeryOvenRecipe));
