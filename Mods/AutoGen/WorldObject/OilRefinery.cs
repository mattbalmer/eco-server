...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public OilRefineryRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(700, typeof(MechanicsSkill), typeof(OilRefineryRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(OilRefineryRecipe), this.UILink(), 20, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Oil Refinery"), typeof(OilRefineryRecipe));
