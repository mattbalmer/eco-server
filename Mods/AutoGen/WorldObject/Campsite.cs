...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CampsiteRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(20, typeof(TailoringSkill), typeof(CampsiteRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CampsiteRecipe), this.UILink(), 6, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Campsite"), typeof(CampsiteRecipe));
