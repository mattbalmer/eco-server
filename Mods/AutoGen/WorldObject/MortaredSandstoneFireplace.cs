...
namespace Eco.Mods.TechTree
{
    ...
    public partial class MortaredSandstoneFireplaceObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Mortared Sandstone Fireplace"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(MortaredSandstoneFireplaceItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(MortaredSandstoneFireplaceItem.HousingVal);                               
    ...
    public partial class MortaredSandstoneFireplaceItem :
        WorldObjectItem<MortaredSandstoneFireplaceObject> 
    {
        ...
        static MortaredSandstoneFireplaceItem()
        {
    ...
    public partial class MortaredSandstoneFireplaceRecipe :
        Recipe
    {
        public MortaredSandstoneFireplaceRecipe()
        {
            var product = new Recipe(
                "MortaredSandstoneFireplace",
