...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AshlarShaleFireplaceObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Ashlar Shale Fireplace"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(AshlarShaleFireplaceItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(AshlarShaleFireplaceItem.HousingVal);                               
    ...
    public partial class AshlarShaleFireplaceItem :
        WorldObjectItem<AshlarShaleFireplaceObject> 
    {
        ...
        static AshlarShaleFireplaceItem()
        {
    ...
    public partial class AshlarShaleFireplaceRecipe :
        Recipe
    {
        public AshlarShaleFireplaceRecipe()
        {
            var product = new Recipe(
                "AshlarShaleFireplace",
                Localizer.DoStr("Ashlar Shale Fireplace"),
