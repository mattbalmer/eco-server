...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeStandingJoshuaSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Large Standing Joshua Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(LargeStandingJoshuaSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static LargeStandingJoshuaSignItem()
        {
    ...
    public partial class LargeStandingJoshuaSignRecipe :
        Recipe
    {
        public LargeStandingJoshuaSignRecipe()
        {
            var product = new Recipe(
                "LargeStandingJoshuaSign",
                Localizer.DoStr("Large Standing Joshua Sign"),
