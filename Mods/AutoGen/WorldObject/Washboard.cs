...
namespace Eco.Mods.TechTree
{
    ...
    public partial class WashboardRecipe :
        RecipeFamily
    {
        public WashboardRecipe()
        {
            var product = new Recipe(
                ...
                {
               new IngredientElement("WoodBoard", 10, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),    
                },
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(TailoringSkill), typeof(WashboardRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WashboardRecipe), this.UILink(), 2, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Washboard"), typeof(WashboardRecipe));
