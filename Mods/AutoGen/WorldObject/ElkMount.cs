...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ElkMountRecipe :
        RecipeFamily
    {
        public ElkMountRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(TailoringSkill), typeof(ElkMountRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ElkMountRecipe), this.UILink(), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Elk Mount"), typeof(ElkMountRecipe));
