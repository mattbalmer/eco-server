...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AshlarBasaltFireplaceObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Ashlar Basalt Fireplace"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(AshlarBasaltFireplaceItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(AshlarBasaltFireplaceItem.HousingVal);                               
    ...
    public partial class AshlarBasaltFireplaceItem :
        WorldObjectItem<AshlarBasaltFireplaceObject> 
    {
        ...
        static AshlarBasaltFireplaceItem()
        {
    ...
    public partial class AshlarBasaltFireplaceRecipe :
        Recipe
    {
        public AshlarBasaltFireplaceRecipe()
        {
            var product = new Recipe(
                "AshlarBasaltFireplace",
                Localizer.DoStr("Ashlar Basalt Fireplace"),
