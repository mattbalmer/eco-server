...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositeFirDoorObject : 
        DoorObject, 
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Composite Fir Door"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public override Type RepresentedItemType { get { return typeof(CompositeFirDoorItem); } } 
    ...
    public partial class CompositeFirDoorRecipe :
        Recipe
    {
        public CompositeFirDoorRecipe()
        {
            var product = new Recipe(
                "CompositeFirDoor",
                Localizer.DoStr("Composite Fir Door"),
                new IngredientElement[]
                {
               new IngredientElement(typeof(CompositeFirLumberItem), 2, typeof(CompositesSkill), typeof(CompositesLavishResourcesTalent)), 
