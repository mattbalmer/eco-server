...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LargeStandingMortaredStoneSignRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(MasonrySkill), typeof(LargeStandingMortaredStoneSignRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LargeStandingMortaredStoneSignRecipe), this.UILink(), 5, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Large Standing Mortared Stone Sign"), typeof(LargeStandingMortaredStoneSignRecipe));
