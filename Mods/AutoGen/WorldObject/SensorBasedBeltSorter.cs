...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SensorBasedBeltSorterRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(1000, typeof(IndustrySkill), typeof(SensorBasedBeltSorterRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SensorBasedBeltSorterRecipe), this.UILink(), 5, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Sensor Based Belt Sorter"), typeof(SensorBasedBeltSorterRecipe));
