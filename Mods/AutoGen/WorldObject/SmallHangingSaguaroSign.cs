...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SmallHangingSaguaroSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Small Hanging Saguaro Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(SmallHangingSaguaroSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static SmallHangingSaguaroSignItem()
        {
    ...
    public partial class SmallHangingSaguaroSignRecipe :
        Recipe
    {
        public SmallHangingSaguaroSignRecipe()
        {
            var product = new Recipe(
                "SmallHangingSaguaroSign",
                Localizer.DoStr("Small Hanging Saguaro Sign"),
