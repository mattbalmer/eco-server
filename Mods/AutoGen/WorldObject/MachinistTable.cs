...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public MachinistTableRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(CarpentrySkill), typeof(MachinistTableRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(MachinistTableRecipe), this.UILink(), 20, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Machinist Table"), typeof(MachinistTableRecipe));
