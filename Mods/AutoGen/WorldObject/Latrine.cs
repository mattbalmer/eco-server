...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LatrineRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(LatrineRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LatrineRecipe), this.UILink(), 4, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Wooden Latrine"), typeof(LatrineRecipe));
