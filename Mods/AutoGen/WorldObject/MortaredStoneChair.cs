...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public MortaredStoneChairRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(50, typeof(MasonrySkill), typeof(MortaredStoneChairRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(MortaredStoneChairRecipe), this.UILink(), 2, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Mortared Stone Chair"), typeof(MortaredStoneChairRecipe));
