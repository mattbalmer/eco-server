...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LaboratoryRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(ElectronicsSkill), typeof(LaboratoryRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LaboratoryRecipe), this.UILink(), 50, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Laboratory"), typeof(LaboratoryRecipe));
