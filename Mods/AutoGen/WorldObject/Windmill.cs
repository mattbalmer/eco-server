...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public WindmillRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(BasicEngineeringSkill), typeof(WindmillRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WindmillRecipe), this.UILink(), 10, typeof(BasicEngineeringSkill), typeof(BasicEngineeringFocusedSpeedTalent), typeof(BasicEngineeringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Windmill"), typeof(WindmillRecipe));
