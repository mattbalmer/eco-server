...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AshlarLargeGneissFountainObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Ashlar Large Gneiss Fountain"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(AshlarLargeGneissFountainItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(AshlarLargeGneissFountainItem.HousingVal);                               
    ...
    public partial class AshlarLargeGneissFountainItem :
        WorldObjectItem<AshlarLargeGneissFountainObject> 
    {
        ...
        static AshlarLargeGneissFountainItem()
        {
    ...
    public partial class AshlarLargeGneissFountainRecipe :
        Recipe
    {
        public AshlarLargeGneissFountainRecipe()
        {
            var product = new Recipe(
                "AshlarLargeGneissFountain",
                Localizer.DoStr("Ashlar Large Gneiss Fountain"),
