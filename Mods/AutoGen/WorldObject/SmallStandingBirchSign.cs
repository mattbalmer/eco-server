...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SmallStandingBirchSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Small Standing Birch Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(SmallStandingBirchSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static SmallStandingBirchSignItem()
        {
    ...
    public partial class SmallStandingBirchSignRecipe :
        Recipe
    {
        public SmallStandingBirchSignRecipe()
        {
            var product = new Recipe(
                "SmallStandingBirchSign",
                Localizer.DoStr("Small Standing Birch Sign"),
