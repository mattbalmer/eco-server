...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CompositeLumberBenchRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(CompositesSkill), typeof(CompositeLumberBenchRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CompositeLumberBenchRecipe), this.UILink(), 4, typeof(CompositesSkill), typeof(CompositesFocusedSpeedTalent), typeof(CompositesParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Composite Lumber Bench"), typeof(CompositeLumberBenchRecipe));
