...
typeof(ElectronicsUpgradeItem), })]  
        ...
        RecipeFamily
    {
        public RoboticAssemblyLineRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(2000, typeof(ElectronicsSkill), typeof(RoboticAssemblyLineRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(RoboticAssemblyLineRecipe), this.UILink(), 75, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Robotic Assembly Line"), typeof(RoboticAssemblyLineRecipe));
