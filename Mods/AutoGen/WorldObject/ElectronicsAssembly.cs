...
typeof(IndustryUpgradeItem), })]  
        ...
        RecipeFamily
    {
        public ElectronicsAssemblyRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(ElectronicsSkill), typeof(ElectronicsAssemblyRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ElectronicsAssemblyRecipe), this.UILink(), 25, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Electronics Assembly"), typeof(ElectronicsAssemblyRecipe));
