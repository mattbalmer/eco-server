...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SmallStandingPalmSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Small Standing Palm Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(SmallStandingPalmSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static SmallStandingPalmSignItem()
        {
    ...
    public partial class SmallStandingPalmSignRecipe :
        Recipe
    {
        public SmallStandingPalmSignRecipe()
        {
            var product = new Recipe(
                "SmallStandingPalmSign",
                Localizer.DoStr("Small Standing Palm Sign"),
