...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public FrothFloatationCellRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(ElectronicsSkill), typeof(FrothFloatationCellRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(FrothFloatationCellRecipe), this.UILink(), 5, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Froth Floatation Cell"), typeof(FrothFloatationCellRecipe));
