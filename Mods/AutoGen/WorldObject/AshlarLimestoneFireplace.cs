...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AshlarLimestoneFireplaceObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Ashlar Limestone Fireplace"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(AshlarLimestoneFireplaceItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(AshlarLimestoneFireplaceItem.HousingVal);                               
    ...
    public partial class AshlarLimestoneFireplaceItem :
        WorldObjectItem<AshlarLimestoneFireplaceObject> 
    {
        ...
        static AshlarLimestoneFireplaceItem()
        {
    ...
    public partial class AshlarLimestoneFireplaceRecipe :
        Recipe
    {
        public AshlarLimestoneFireplaceRecipe()
        {
            var product = new Recipe(
                "AshlarLimestoneFireplace",
                Localizer.DoStr("Ashlar Limestone Fireplace"),
