...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ElectricPlanerRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(400, typeof(IndustrySkill), typeof(ElectricPlanerRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ElectricPlanerRecipe), this.UILink(), 8, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Electric Planer"), typeof(ElectricPlanerRecipe));
