...
namespace Eco.Mods.TechTree
{
    ...
    public partial class TallowWallLampRecipe :
        RecipeFamily
    {
        public TallowWallLampRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(80, typeof(SmeltingSkill), typeof(TallowWallLampRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(TallowWallLampRecipe), this.UILink(), 3, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Tallow Wall Lamp"), typeof(TallowWallLampRecipe));
