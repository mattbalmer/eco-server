...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CompositeLumberDoorRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(CompositesSkill), typeof(CompositeLumberDoorRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CompositeLumberDoorRecipe), this.UILink(), 4, typeof(CompositesSkill), typeof(CompositesFocusedSpeedTalent), typeof(CompositesParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Composite Lumber Door"), typeof(CompositeLumberDoorRecipe));
