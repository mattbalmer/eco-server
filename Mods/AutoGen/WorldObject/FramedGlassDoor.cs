...
namespace Eco.Mods.TechTree
{
    ...
    public partial class FramedGlassDoorRecipe :
        RecipeFamily
    {
        public FramedGlassDoorRecipe()
        {
            var product = new Recipe(
                "FramedGlassDoor",
                Localizer.DoStr("Framed Glass Door"),
                new IngredientElement[]
                {
               new IngredientElement(typeof(GlassItem), 40, typeof(GlassworkingSkill), typeof(GlassworkingLavishResourcesTalent)), 
               new IngredientElement(typeof(SteelBarItem), 10, typeof(GlassworkingSkill), typeof(GlassworkingLavishResourcesTalent)),    
                },
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(190, typeof(GlassworkingSkill), typeof(FramedGlassDoorRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(FramedGlassDoorRecipe), this.UILink(), 8, typeof(GlassworkingSkill), typeof(GlassworkingFocusedSpeedTalent), typeof(GlassworkingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Framed Glass Door"), typeof(FramedGlassDoorRecipe));
