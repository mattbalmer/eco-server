...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ElectricWallLampRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(ElectronicsSkill), typeof(ElectricWallLampRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ElectricWallLampRecipe), this.UILink(), 4, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Electric Wall Lamp"), typeof(ElectricWallLampRecipe));
