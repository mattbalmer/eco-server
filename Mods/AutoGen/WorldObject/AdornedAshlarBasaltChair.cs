...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AdornedAshlarBasaltChairObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Adorned Ashlar Basalt Chair"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(AdornedAshlarBasaltChairItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(AdornedAshlarBasaltChairItem.HousingVal);                               
    ...
    public partial class AdornedAshlarBasaltChairItem :
        WorldObjectItem<AdornedAshlarBasaltChairObject> 
    {
        ...
        static AdornedAshlarBasaltChairItem()
        {
    ...
    public partial class AdornedAshlarBasaltChairRecipe :
        Recipe
    {
        public AdornedAshlarBasaltChairRecipe()
        {
            var product = new Recipe(
                "AdornedAshlarBasaltChair",
                Localizer.DoStr("Adorned Ashlar Basalt Chair"),
