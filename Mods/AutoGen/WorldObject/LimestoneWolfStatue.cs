...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LimestoneWolfStatueRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(MasonrySkill), typeof(LimestoneWolfStatueRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LimestoneWolfStatueRecipe), this.UILink(), 7, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Limestone Wolf Statue"), typeof(LimestoneWolfStatueRecipe));
