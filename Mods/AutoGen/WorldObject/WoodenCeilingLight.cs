...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public WoodenCeilingLightRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(CarpentrySkill), typeof(WoodenCeilingLightRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WoodenCeilingLightRecipe), this.UILink(), 4, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Wooden Ceiling Light"), typeof(WoodenCeilingLightRecipe));
