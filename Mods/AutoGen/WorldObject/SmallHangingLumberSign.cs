        ...
        RecipeFamily
    {
        public SmallHangingLumberSignRecipe()
        {
            var product = new Recipe(
                "SmallHangingLumberSign",
                Localizer.DoStr("Small Hanging Lumber Sign"),
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(SmallHangingLumberSignRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SmallHangingLumberSignRecipe), this.UILink(), 5, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Small Hanging Lumber Sign"), typeof(SmallHangingLumberSignRecipe));
