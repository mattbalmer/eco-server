...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CouchRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(160, typeof(TailoringSkill), typeof(CouchRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CouchRecipe), this.UILink(), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Couch"), typeof(CouchRecipe));
