...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositeJoshuaTableObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Composite Joshua Table"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(CompositeJoshuaTableItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(CompositeJoshuaTableItem.HousingVal);                               
    ...
    public partial class CompositeJoshuaTableItem :
        WorldObjectItem<CompositeJoshuaTableObject> 
    {
        ...
        static CompositeJoshuaTableItem()
        {
    ...
    public partial class CompositeJoshuaTableRecipe :
        Recipe
    {
        public CompositeJoshuaTableRecipe()
        {
            var product = new Recipe(
                "CompositeJoshuaTable",
                Localizer.DoStr("Composite Joshua Table"),
