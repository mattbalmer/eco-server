...
namespace Eco.Mods.TechTree
{
    ...
    public partial class BoardOfElectionsObject : 
        CivicObject, 
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Board Of Elections"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Paper; 

        public virtual Type RepresentedItemType { get { return typeof(BoardOfElectionsItem); } } 
    ...
    public partial class BoardOfElectionsRecipe :
        RecipeFamily
    {
        public BoardOfElectionsRecipe()
        {
            var product = new Recipe(
                "BoardOfElections",
                Localizer.DoStr("Board Of Elections"),
            ...
            this.Initialize(Localizer.DoStr("Board Of Elections"), typeof(BoardOfElectionsRecipe));
