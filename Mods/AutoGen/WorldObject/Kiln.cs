...
typeof(LoggingAdvancedUpgradeItem), })]  
        ...
        RecipeFamily
    {
        public KilnRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(600, typeof(MasonrySkill), typeof(KilnRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(KilnRecipe), this.UILink(), 10, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Kiln"), typeof(KilnRecipe));
