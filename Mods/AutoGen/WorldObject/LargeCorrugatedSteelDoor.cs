...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeCorrugatedSteelDoorRecipe :
        RecipeFamily
    {
        public LargeCorrugatedSteelDoorRecipe()
        {
            var product = new Recipe(
                "LargeCorrugatedSteelDoor",
                Localizer.DoStr("Large Corrugated Steel Door"),
                new IngredientElement[]
                {
               new IngredientElement(typeof(SteelBarItem), 50, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingLavishResourcesTalent)),    
                },
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(800, typeof(AdvancedSmeltingSkill), typeof(LargeCorrugatedSteelDoorRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LargeCorrugatedSteelDoorRecipe), this.UILink(), 10, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Large Corrugated Steel Door"), typeof(LargeCorrugatedSteelDoorRecipe));
