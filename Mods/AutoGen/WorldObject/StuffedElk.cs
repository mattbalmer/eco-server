...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public StuffedElkRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(TailoringSkill), typeof(StuffedElkRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(StuffedElkRecipe), this.UILink(), 12, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Stuffed Elk"), typeof(StuffedElkRecipe));
