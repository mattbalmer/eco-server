...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SmallHangingPalmSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Small Hanging Palm Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(SmallHangingPalmSignItem); } } 
    ...
    public partial class SmallHangingPalmSignRecipe :
        Recipe
    {
        public SmallHangingPalmSignRecipe()
        {
            var product = new Recipe(
                "SmallHangingPalmSign",
