...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ElectricWaterPumpRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(MechanicsSkill), typeof(ElectricWaterPumpRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ElectricWaterPumpRecipe), this.UILink(), 8, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Electric Water Pump"), typeof(ElectricWaterPumpRecipe));
