...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public RealEstateDeskRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(RealEstateDeskRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(RealEstateDeskRecipe), this.UILink(), 2, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Real Estate Desk"), typeof(RealEstateDeskRecipe));
