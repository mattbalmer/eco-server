...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelTableLampRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(ElectronicsSkill), typeof(SteelTableLampRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelTableLampRecipe), this.UILink(), 4, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Steel Table Lamp"), typeof(SteelTableLampRecipe));
