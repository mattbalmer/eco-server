...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeStandingSpruceSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Large Standing Spruce Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(LargeStandingSpruceSignItem); } } 
        ...
        ,IPersistentData 
    {
        ...
        static LargeStandingSpruceSignItem()
        {
    ...
    public partial class LargeStandingSpruceSignRecipe :
        Recipe
    {
        public LargeStandingSpruceSignRecipe()
        {
            var product = new Recipe(
                "LargeStandingSpruceSign",
                Localizer.DoStr("Large Standing Spruce Sign"),
