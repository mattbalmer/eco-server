...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public WainwrightTableRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(CarpentrySkill), typeof(WainwrightTableRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WainwrightTableRecipe), this.UILink(), 5, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Wainwright Table"), typeof(WainwrightTableRecipe));
