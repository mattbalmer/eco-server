...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositeHardwoodTableObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Composite Hardwood Table"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(CompositeHardwoodTableItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(CompositeHardwoodTableItem.HousingVal);                               
    ...
    public partial class CompositeHardwoodTableItem :
        WorldObjectItem<CompositeHardwoodTableObject> 
    {
        ...
        static CompositeHardwoodTableItem()
        {
    ...
    public partial class CompositeHardwoodTableRecipe :
        Recipe
    {
        public CompositeHardwoodTableRecipe()
        {
            var product = new Recipe(
                "CompositeHardwoodTable",
                Localizer.DoStr("Composite Hardwood Table"),
