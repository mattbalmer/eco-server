...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CompositeLumberChairRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(CompositesSkill), typeof(CompositeLumberChairRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CompositeLumberChairRecipe), this.UILink(), 3, typeof(CompositesSkill), typeof(CompositesFocusedSpeedTalent), typeof(CompositesParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Composite Lumber Chair"), typeof(CompositeLumberChairRecipe));
