...
typeof(IndustryUpgradeItem), })]  
        ...
        RecipeFamily
    {
        public AssemblyLineRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(400, typeof(MechanicsSkill), typeof(AssemblyLineRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(AssemblyLineRecipe), this.UILink(), 40, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Assembly Line"), typeof(AssemblyLineRecipe));
