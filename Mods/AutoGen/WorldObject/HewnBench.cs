...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public HewnBenchRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(HewnBenchRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(HewnBenchRecipe), this.UILink(), 4, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Hewn Bench"), typeof(HewnBenchRecipe));
