...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public MintRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(1500, typeof(SmeltingSkill), typeof(MintRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(MintRecipe), this.UILink(), 25, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Mint"), typeof(MintRecipe));
