...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositeOakDoorObject : 
        DoorObject, 
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Composite Oak Door"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public override Type RepresentedItemType { get { return typeof(CompositeOakDoorItem); } } 
    ...
    public partial class CompositeOakDoorRecipe :
        Recipe
    {
        public CompositeOakDoorRecipe()
        {
            var product = new Recipe(
                "CompositeOakDoor",
                Localizer.DoStr("Composite Oak Door"),
                new IngredientElement[]
                {
               new IngredientElement(typeof(CompositeOakLumberItem), 2, typeof(CompositesSkill), typeof(CompositesLavishResourcesTalent)), 
