...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LumberDoorRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(LumberDoorRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LumberDoorRecipe), this.UILink(), 1, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Lumber Door"), typeof(LumberDoorRecipe));
