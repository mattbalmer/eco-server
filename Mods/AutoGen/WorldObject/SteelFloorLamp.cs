...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelFloorLampRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(ElectronicsSkill), typeof(SteelFloorLampRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelFloorLampRecipe), this.UILink(), 4, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Steel Floor Lamp"), typeof(SteelFloorLampRecipe));
