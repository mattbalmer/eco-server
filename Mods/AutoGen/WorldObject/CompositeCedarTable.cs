...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositeCedarTableObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Composite Cedar Table"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(CompositeCedarTableItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(CompositeCedarTableItem.HousingVal);                               
    ...
    public partial class CompositeCedarTableItem :
        WorldObjectItem<CompositeCedarTableObject> 
    {
        ...
        static CompositeCedarTableItem()
        {
    ...
    public partial class CompositeCedarTableRecipe :
        Recipe
    {
        public CompositeCedarTableRecipe()
        {
            var product = new Recipe(
                "CompositeCedarTable",
                Localizer.DoStr("Composite Cedar Table"),
