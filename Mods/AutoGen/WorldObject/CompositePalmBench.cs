...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositePalmBenchObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Composite Palm Bench"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(CompositePalmBenchItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(CompositePalmBenchItem.HousingVal);                               
    ...
    public partial class CompositePalmBenchRecipe :
        Recipe
    {
        public CompositePalmBenchRecipe()
        {
            var product = new Recipe(
                "CompositePalmBench",
                Localizer.DoStr("Composite Palm Bench"),
