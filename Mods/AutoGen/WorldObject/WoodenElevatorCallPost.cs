...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public WoodenElevatorCallPostRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(CarpentrySkill), typeof(WoodenElevatorCallPostRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WoodenElevatorCallPostRecipe), this.UILink(), 5, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Wooden Elevator Call Post"), typeof(WoodenElevatorCallPostRecipe));
