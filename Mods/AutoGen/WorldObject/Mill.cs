...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public MillRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(600, typeof(MasonrySkill), typeof(MillRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(MillRecipe), this.UILink(), 8, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Mill"), typeof(MillRecipe));
