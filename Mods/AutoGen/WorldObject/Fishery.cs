...
namespace Eco.Mods.TechTree
{
    ...
    public partial class FisheryRecipe :
        RecipeFamily
    {
        public FisheryRecipe()
        {
            var product = new Recipe(
                "Fishery",
                Localizer.DoStr("Fishery"),
                new IngredientElement[]
                {
               new IngredientElement("HewnLog", 14, typeof(HuntingSkill)), 
               new IngredientElement("WoodBoard", 8, typeof(HuntingSkill)),    
                },
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(HuntingSkill), typeof(FisheryRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(FisheryRecipe), this.UILink(), 1, typeof(HuntingSkill));     
            this.Initialize(Localizer.DoStr("Fishery"), typeof(FisheryRecipe));
