...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public StoneBrazierRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(40, typeof(MasonrySkill), typeof(StoneBrazierRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(StoneBrazierRecipe), this.UILink(), 4, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Stone Brazier"), typeof(StoneBrazierRecipe));
