...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public RugLargeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(TailoringSkill), typeof(RugLargeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(RugLargeRecipe), this.UILink(), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Rug Large"), typeof(RugLargeRecipe));
