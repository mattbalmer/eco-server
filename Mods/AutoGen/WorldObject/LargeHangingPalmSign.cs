...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeHangingPalmSignObject : 
        WorldObject,    
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Large Hanging Palm Sign"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public virtual Type RepresentedItemType { get { return typeof(LargeHangingPalmSignItem); } } 
    ...
    public partial class LargeHangingPalmSignRecipe :
        Recipe
    {
        public LargeHangingPalmSignRecipe()
        {
            var product = new Recipe(
                "LargeHangingPalmSign",
                Localizer.DoStr("Large Hanging Palm Sign"),
