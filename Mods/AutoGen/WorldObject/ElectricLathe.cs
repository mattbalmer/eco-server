...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ElectricLatheRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(400, typeof(IndustrySkill), typeof(ElectricLatheRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ElectricLatheRecipe), this.UILink(), 8, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Electric Lathe"), typeof(ElectricLatheRecipe));
