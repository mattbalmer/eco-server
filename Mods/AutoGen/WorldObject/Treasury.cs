...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public TreasuryRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(2500, typeof(SmeltingSkill), typeof(TreasuryRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(TreasuryRecipe), this.UILink(), 25, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Treasury"), typeof(TreasuryRecipe));
