...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AdornedAshlarSandstoneChairObject : 
        ...
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Adorned Ashlar Sandstone Chair"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Stone; 

        public virtual Type RepresentedItemType { get { return typeof(AdornedAshlarSandstoneChairItem); } } 
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().Set(AdornedAshlarSandstoneChairItem.HousingVal);                               
    ...
    public partial class AdornedAshlarSandstoneChairItem :
        WorldObjectItem<AdornedAshlarSandstoneChairObject> 
    {
        ...
        static AdornedAshlarSandstoneChairItem()
        {
    ...
    public partial class AdornedAshlarSandstoneChairRecipe :
        Recipe
    {
        public AdornedAshlarSandstoneChairRecipe()
        {
            var product = new Recipe(
                "AdornedAshlarSandstoneChair",
                Localizer.DoStr("Adorned Ashlar Sandstone Chair"),
