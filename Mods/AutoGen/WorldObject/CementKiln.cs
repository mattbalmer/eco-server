...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CementKilnRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(1000, typeof(SmeltingSkill), typeof(CementKilnRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CementKilnRecipe), this.UILink(), 100, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Cement Kiln"), typeof(CementKilnRecipe));
