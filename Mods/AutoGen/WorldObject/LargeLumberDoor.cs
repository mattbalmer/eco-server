...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LargeLumberDoorRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(LargeLumberDoorRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LargeLumberDoorRecipe), this.UILink(), 8, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Large Lumber Door"), typeof(LargeLumberDoorRecipe));
