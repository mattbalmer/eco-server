...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ModernStreetLightRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(ElectronicsSkill), typeof(ModernStreetLightRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ModernStreetLightRecipe), this.UILink(), 6, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Modern Street Light"), typeof(ModernStreetLightRecipe));
