...
namespace Eco.Mods.TechTree
{
    ...
    public partial class PumpJackRecipe :
        RecipeFamily
    {
        public PumpJackRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(120, typeof(MechanicsSkill), typeof(PumpJackRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(PumpJackRecipe), this.UILink(), 20, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Pump Jack"), typeof(PumpJackRecipe));
