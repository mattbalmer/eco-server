...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SoftwoodLumberDoorObject : 
        DoorObject, 
        IRepresentsItem
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Softwood Lumber Door"); } } 

        public override TableTextureMode TableTexture => TableTextureMode.Wood; 

        public override Type RepresentedItemType { get { return typeof(SoftwoodLumberDoorItem); } } 
    ...
    public partial class SoftwoodLumberDoorRecipe :
        Recipe
    {
        public SoftwoodLumberDoorRecipe()
        {
            var product = new Recipe(
                "SoftwoodLumberDoor",
                Localizer.DoStr("Softwood Lumber Door"),
                new IngredientElement[]
                {
               new IngredientElement(typeof(SoftwoodLumberItem), 2, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)), 
