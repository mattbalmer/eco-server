...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public HewnChairRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(CarpentrySkill), typeof(HewnChairRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(HewnChairRecipe), this.UILink(), 3, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Hewn Chair"), typeof(HewnChairRecipe));
