...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ShaperRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(MechanicsSkill), typeof(ShaperRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ShaperRecipe), this.UILink(), 5, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Shaper"), typeof(ShaperRecipe));
