...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CrushedLimestoneRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(MiningSkill), typeof(CrushedLimestoneRecipe), this.UILink()); 
            this.ExperienceOnCraft = 0.5f;  
            this.CraftMinutes = CreateCraftTimeValue(typeof(CrushedLimestoneRecipe), this.UILink(), 1.5f, typeof(MiningSkill));     
