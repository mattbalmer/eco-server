...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositeCeibaLumberRecipe :
        Recipe
    {
    ...
    [Serialized, Solid] public class CompositeCeibaLumberStacked1Block : PickupableBlock { }
    [Serialized, Solid] public class CompositeCeibaLumberStacked2Block : PickupableBlock { }
    [Serialized, Solid] public class CompositeCeibaLumberStacked3Block : PickupableBlock { }
    [Serialized, Solid,Wall] public class CompositeCeibaLumberStacked4Block : PickupableBlock { } //Only a wall if it's all 4 CompositeCeibaLumber
}
