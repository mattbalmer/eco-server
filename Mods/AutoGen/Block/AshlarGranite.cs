...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AshlarGraniteRecipe :
        RecipeFamily
    {
        public AshlarGraniteRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                   ...
                   new CraftingElement<CrushedGraniteItem>(typeof(AdvancedMasonrySkill), 2), 
 
                    }
                )
            };
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(AdvancedMasonrySkill), typeof(AshlarGraniteRecipe), this.UILink()); 
            this.ExperienceOnCraft = 1.5f;  
            this.CraftMinutes = CreateCraftTimeValue(typeof(AshlarGraniteRecipe), this.UILink(), 2, typeof(AdvancedMasonrySkill), typeof(AdvancedMasonryFocusedSpeedTalent), typeof(AdvancedMasonryParallelSpeedTalent));     
