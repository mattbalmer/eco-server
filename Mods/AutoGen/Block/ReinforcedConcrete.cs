...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ReinforcedConcreteRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(40, typeof(MasonrySkill), typeof(ReinforcedConcreteRecipe), this.UILink()); 
            this.ExperienceOnCraft = 1;  
            this.CraftMinutes = CreateCraftTimeValue(typeof(ReinforcedConcreteRecipe), this.UILink(), 4, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
