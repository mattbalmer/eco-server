...
namespace Eco.Mods.TechTree
{
    ...
    public class TomatoSeedRecipe : RecipeFamily
    {
        public TomatoSeedRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(20, typeof(FarmingSkill), typeof(TomatoSeedRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(TomatoSeedRecipe), this.UILink(), 1, typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));    
