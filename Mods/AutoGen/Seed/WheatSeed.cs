...
namespace Eco.Mods.TechTree
{
    ...
    public class WheatSeedRecipe : RecipeFamily
    {
        public WheatSeedRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(20, typeof(FarmingSkill), typeof(WheatSeedRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WheatSeedRecipe), this.UILink(), 1, typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));    
