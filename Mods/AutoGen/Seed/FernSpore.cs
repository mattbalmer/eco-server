...
namespace Eco.Mods.TechTree
{
    ...
    public class FernSporeRecipe : RecipeFamily
    {
        public FernSporeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(20, typeof(FarmingSkill), typeof(FernSporeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(FernSporeRecipe), this.UILink(), 1, typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));    
