...
namespace Eco.Mods.TechTree
{
    ...
    public class FireweedSeedRecipe : RecipeFamily
    {
        public FireweedSeedRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(20, typeof(FarmingSkill), typeof(FireweedSeedRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(FireweedSeedRecipe), this.UILink(), 1, typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));    
