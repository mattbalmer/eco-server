...
namespace Eco.Mods.TechTree
{
    ...
    public class HuckleberrySeedRecipe : RecipeFamily
    {
        public HuckleberrySeedRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(20, typeof(FarmingSkill), typeof(HuckleberrySeedRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(HuckleberrySeedRecipe), this.UILink(), 1, typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));    
