...
namespace Eco.Mods.TechTree
{
    ...
    public class CookeinaMushroomSporesRecipe : RecipeFamily
    {
        public CookeinaMushroomSporesRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(20, typeof(FarmingSkill), typeof(CookeinaMushroomSporesRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CookeinaMushroomSporesRecipe), this.UILink(), 1, typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));    
