...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public AdvancedUpgradeLvl4Recipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(150, typeof(MechanicsSkill), typeof(AdvancedUpgradeLvl4Recipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(AdvancedUpgradeLvl4Recipe), this.UILink(), 12, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Advanced Upgrade 4"), typeof(AdvancedUpgradeLvl4Recipe));
