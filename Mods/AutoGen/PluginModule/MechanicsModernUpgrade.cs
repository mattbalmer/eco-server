...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public MechanicsModernUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(10000, typeof(MechanicsSkill), typeof(MechanicsModernUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(MechanicsModernUpgradeRecipe), this.UILink(), 15, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Mechanics Modern Upgrade"), typeof(MechanicsModernUpgradeRecipe));
