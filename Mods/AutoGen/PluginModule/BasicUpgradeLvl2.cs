...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public BasicUpgradeLvl2Recipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(MasonrySkill), typeof(BasicUpgradeLvl2Recipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(BasicUpgradeLvl2Recipe), this.UILink(), 4, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Basic Upgrade 2"), typeof(BasicUpgradeLvl2Recipe));
