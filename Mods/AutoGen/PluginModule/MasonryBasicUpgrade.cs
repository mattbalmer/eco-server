...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public MasonryBasicUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(5000, typeof(MasonrySkill), typeof(MasonryBasicUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(MasonryBasicUpgradeRecipe), this.UILink(), 10, typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Masonry Basic Upgrade"), typeof(MasonryBasicUpgradeRecipe));
