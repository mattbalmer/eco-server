...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ButcheryUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(5000, typeof(ButcherySkill), typeof(ButcheryUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ButcheryUpgradeRecipe), this.UILink(), 10, typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Butchery Basic Upgrade"), typeof(ButcheryUpgradeRecipe));
