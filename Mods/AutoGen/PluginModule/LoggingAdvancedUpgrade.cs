...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LoggingAdvancedUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(5000, typeof(LoggingSkill), typeof(LoggingAdvancedUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LoggingAdvancedUpgradeRecipe), this.UILink(), 10, typeof(LoggingSkill));     
            this.Initialize(Localizer.DoStr("Logging Advanced Upgrade"), typeof(LoggingAdvancedUpgradeRecipe));
