...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public AdvancedBakingUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(10000, typeof(AdvancedBakingSkill), typeof(AdvancedBakingUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(AdvancedBakingUpgradeRecipe), this.UILink(), 15, typeof(AdvancedBakingSkill), typeof(AdvancedBakingFocusedSpeedTalent), typeof(AdvancedBakingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Advanced Baking Advanced Upgrade"), typeof(AdvancedBakingUpgradeRecipe));
