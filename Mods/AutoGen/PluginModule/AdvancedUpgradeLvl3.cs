...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public AdvancedUpgradeLvl3Recipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(150, typeof(SmeltingSkill), typeof(AdvancedUpgradeLvl3Recipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(AdvancedUpgradeLvl3Recipe), this.UILink(), 9, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Advanced Upgrade 3"), typeof(AdvancedUpgradeLvl3Recipe));
