...
namespace Eco.Mods.TechTree
{
    ...
    public partial class TailoringUpgradeRecipe :
        RecipeFamily
    {
        public TailoringUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(5000, typeof(TailoringSkill), typeof(TailoringUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(TailoringUpgradeRecipe), this.UILink(), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Tailoring Basic Upgrade"), typeof(TailoringUpgradeRecipe));
    ...
    public partial class TailoringUpgradeItem :
        EfficiencyModule 
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("Basic Upgrade that greatly increases efficiency when crafting Tailroing recipes"); } }
