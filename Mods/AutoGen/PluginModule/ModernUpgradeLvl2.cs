...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ModernUpgradeLvl2Recipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(IndustrySkill), typeof(ModernUpgradeLvl2Recipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ModernUpgradeLvl2Recipe), this.UILink(), 6, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Modern Upgrade 2"), typeof(ModernUpgradeLvl2Recipe));
