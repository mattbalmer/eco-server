...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public IndustryUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(15000, typeof(IndustrySkill), typeof(IndustryUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(IndustryUpgradeRecipe), this.UILink(), 18, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Industry Modern Upgrade"), typeof(IndustryUpgradeRecipe));
