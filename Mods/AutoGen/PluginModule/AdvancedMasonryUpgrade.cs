...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public AdvancedMasonryUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(15000, typeof(AdvancedMasonrySkill), typeof(AdvancedMasonryUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(AdvancedMasonryUpgradeRecipe), this.UILink(), 18, typeof(AdvancedMasonrySkill), typeof(AdvancedMasonryFocusedSpeedTalent), typeof(AdvancedMasonryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Advanced Masonry Modern Upgrade"), typeof(AdvancedMasonryUpgradeRecipe));
