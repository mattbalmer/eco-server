...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CarpentryBasicUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(5000, typeof(CarpentrySkill), typeof(CarpentryBasicUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CarpentryBasicUpgradeRecipe), this.UILink(), 10, typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Carpentry Basic Upgrade"), typeof(CarpentryBasicUpgradeRecipe));
