...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public MechanicsAdvancedUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(10000, typeof(MechanicsSkill), typeof(MechanicsAdvancedUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(MechanicsAdvancedUpgradeRecipe), this.UILink(), 15, typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Mechanics Advanced Upgrade"), typeof(MechanicsAdvancedUpgradeRecipe));
