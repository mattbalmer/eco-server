...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public LoggingBasicUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(5000, typeof(LoggingSkill), typeof(LoggingBasicUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LoggingBasicUpgradeRecipe), this.UILink(), 10, typeof(LoggingSkill));     
            this.Initialize(Localizer.DoStr("Logging Basic Upgrade"), typeof(LoggingBasicUpgradeRecipe));
