...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ModernUpgradeLvl4Recipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(2000, typeof(CompositesSkill), typeof(ModernUpgradeLvl4Recipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ModernUpgradeLvl4Recipe), this.UILink(), 14, typeof(CompositesSkill), typeof(CompositesFocusedSpeedTalent), typeof(CompositesParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Modern Upgrade 4"), typeof(ModernUpgradeLvl4Recipe));
