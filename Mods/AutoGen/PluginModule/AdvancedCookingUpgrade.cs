...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public AdvancedCookingUpgradeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(10000, typeof(AdvancedCookingSkill), typeof(AdvancedCookingUpgradeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(AdvancedCookingUpgradeRecipe), this.UILink(), 15, typeof(AdvancedCookingSkill), typeof(AdvancedCookingFocusedSpeedTalent), typeof(AdvancedCookingParallelSpeedTalent));     
            this.Initialize(Localizer.DoStr("Advanced Cooking Advanced Upgrade"), typeof(AdvancedCookingUpgradeRecipe));
