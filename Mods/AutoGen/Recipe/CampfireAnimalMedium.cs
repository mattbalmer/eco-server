...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public CampfireAnimalMediumRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(40, typeof(CampfireCookingSkill), typeof(CampfireAnimalMediumRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CampfireAnimalMediumRecipe), this.UILink(), 2.5f, typeof(CampfireCookingSkill), typeof(CampfireCookingFocusedSpeedTalent), typeof(CampfireCookingParallelSpeedTalent));     
