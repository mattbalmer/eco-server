...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ConcentrateDryIronLv2Recipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(MiningSkill), typeof(ConcentrateDryIronLv2Recipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ConcentrateDryIronLv2Recipe), this.UILink(), 0.4f, typeof(MiningSkill));     
