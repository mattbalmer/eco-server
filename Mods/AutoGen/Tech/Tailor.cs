...
namespace Eco.Mods.TechTree
{
    ...
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("Tailorings work with cloth to make high-end furniture.and clothing that provides special bonuses when worn."); } }
