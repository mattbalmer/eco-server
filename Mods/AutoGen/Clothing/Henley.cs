...
namespace Eco.Mods.TechTree
{
    ...
    public class HenleyRecipe : RecipeFamily
    {
        public HenleyRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(HenleyRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(HenleyRecipe), this.UILink(), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Henley"), typeof(HenleyRecipe));
