...
public override Dictionary<UserStatType, float> GetFlatStats() { return flatStats; }
    ...
    public class RunningShoesRecipe : RecipeFamily
    {
        public RunningShoesRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(RunningShoesRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(RunningShoesRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Running Shoes"), typeof(RunningShoesRecipe));
