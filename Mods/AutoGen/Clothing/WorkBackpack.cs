...
public override Dictionary<UserStatType, float> GetFlatStats() { return flatStats; }
    ...
    public class WorkBackpackRecipe : RecipeFamily
    {
        public WorkBackpackRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(WorkBackpackRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WorkBackpackRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Work Backpack"), typeof(WorkBackpackRecipe));
