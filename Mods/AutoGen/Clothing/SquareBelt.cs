...
namespace Eco.Mods.TechTree
{
    ...
    public class SquareBeltRecipe : RecipeFamily
    {
        public SquareBeltRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(SquareBeltRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SquareBeltRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Square Belt"), typeof(SquareBeltRecipe));
