...
namespace Eco.Mods.TechTree
{
    ...
    public class LowTopShoesRecipe : RecipeFamily
    {
        public LowTopShoesRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(LowTopShoesRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LowTopShoesRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Low Top Shoes"), typeof(LowTopShoesRecipe));
