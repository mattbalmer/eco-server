...
namespace Eco.Mods.TechTree
{
    ...
    public class TrousersRecipe : RecipeFamily
    {
        public TrousersRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(TrousersRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(TrousersRecipe), this.UILink(), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Trousers"), typeof(TrousersRecipe));
