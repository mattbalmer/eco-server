...
public override Dictionary<UserStatType, float> GetFlatStats() { return flatStats; }
    ...
    public class LightBackpackRecipe : RecipeFamily
    {
        public LightBackpackRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(LightBackpackRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(LightBackpackRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Light Backpack"), typeof(LightBackpackRecipe));
