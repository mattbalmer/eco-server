...
public override Dictionary<UserStatType, float> GetFlatStats() { return flatStats; }
    ...
    public class WorkBootsRecipe : RecipeFamily
    {
        public WorkBootsRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(WorkBootsRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(WorkBootsRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Work Boots"), typeof(WorkBootsRecipe));
