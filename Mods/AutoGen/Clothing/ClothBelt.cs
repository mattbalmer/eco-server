...
namespace Eco.Mods.TechTree
{
    ...
    public class ClothBeltRecipe : RecipeFamily
    {
        public ClothBeltRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(ClothBeltRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ClothBeltRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Cloth Belt"), typeof(ClothBeltRecipe));
