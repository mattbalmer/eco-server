...
namespace Eco.Mods.TechTree
{
    ...
    public class ClothBeltRecipe : RecipeFamily
    {
        public ClothBeltRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(ClothBeltRecipe), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
