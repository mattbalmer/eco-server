...
namespace Eco.Mods.TechTree
{
    ...
    public class ShortsRecipe : RecipeFamily
    {
        public ShortsRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(ShortsRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ShortsRecipe), this.UILink(), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Shorts"), typeof(ShortsRecipe));
