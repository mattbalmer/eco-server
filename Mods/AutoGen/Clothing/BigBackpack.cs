...
public override Dictionary<UserStatType, float> GetFlatStats() { return flatStats; }
    ...
    public class BigBackpackRecipe : RecipeFamily
    {
        public BigBackpackRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(BigBackpackRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(BigBackpackRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Big Backpack"), typeof(BigBackpackRecipe));
