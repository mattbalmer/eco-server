...
namespace Eco.Mods.TechTree
{
    ...
    public class DerpyHatRecipe : RecipeFamily
    {
        public DerpyHatRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(DerpyHatRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(DerpyHatRecipe), this.UILink(), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Derpy Hat"), typeof(DerpyHatRecipe));
