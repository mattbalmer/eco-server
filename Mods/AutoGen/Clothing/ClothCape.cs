...
namespace Eco.Mods.TechTree
{
    ...
    public class ClothCapeRecipe : RecipeFamily
    {
        public ClothCapeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(ClothCapeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ClothCapeRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Cloth Cape"), typeof(ClothCapeRecipe));
