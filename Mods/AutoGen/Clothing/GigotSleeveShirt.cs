...
namespace Eco.Mods.TechTree
{
    ...
    public class GigotSleeveShirtRecipe : RecipeFamily
    {
        public GigotSleeveShirtRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(GigotSleeveShirtRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(GigotSleeveShirtRecipe), this.UILink(), 10, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Gigot Sleeve Shirt"), typeof(GigotSleeveShirtRecipe));
