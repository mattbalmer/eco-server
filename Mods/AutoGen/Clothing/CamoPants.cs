...
public override Dictionary<UserStatType, float> GetFlatStats() { return flatStats; }
    ...
    public class CamoPantsRecipe : RecipeFamily
    {
        public CamoPantsRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(60, typeof(TailoringSkill), typeof(CamoPantsRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CamoPantsRecipe), this.UILink(), 1, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent)); 
            this.Initialize(Localizer.DoStr("Camo Pants"), typeof(CamoPantsRecipe));
