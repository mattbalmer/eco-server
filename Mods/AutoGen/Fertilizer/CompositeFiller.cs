...
namespace Eco.Mods.TechTree
{
    ...
    public partial class CompositeFillerRecipe : RecipeFamily
    {
        public CompositeFillerRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(25, typeof(FertilizersSkill), typeof(CompositeFillerRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(CompositeFillerRecipe), this.UILink(), 0.3f, typeof(FertilizersSkill), typeof(FertilizersFocusedSpeedTalent), typeof(FertilizersParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Composite Filler"), typeof(CompositeFillerRecipe));
