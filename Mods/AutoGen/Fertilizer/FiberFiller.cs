...
namespace Eco.Mods.TechTree
{
    ...
    public partial class FiberFillerRecipe : RecipeFamily
    {
        public FiberFillerRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(25, typeof(FertilizersSkill), typeof(FiberFillerRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(FiberFillerRecipe), this.UILink(), 0.3f, typeof(FertilizersSkill), typeof(FertilizersFocusedSpeedTalent), typeof(FertilizersParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Fiber Filler"), typeof(FiberFillerRecipe));
