...
namespace Eco.Mods.TechTree
{
    ...
    public partial class MetallurgyResearchPaperModernRecipe :
        RecipeFamily
    {
        public MetallurgyResearchPaperModernRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(1000, typeof(AdvancedSmeltingSkill), typeof(MetallurgyResearchPaperModernRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(1);
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Metallurgy Research Paper Modern"), typeof(MetallurgyResearchPaperModernRecipe));
