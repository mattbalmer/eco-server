...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public PlasticRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(OilDrillingSkill), typeof(PlasticRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(PlasticRecipe), this.UILink(), 1.6f, typeof(OilDrillingSkill), typeof(OilDrillingFocusedSpeedTalent), typeof(OilDrillingParallelSpeedTalent));     
