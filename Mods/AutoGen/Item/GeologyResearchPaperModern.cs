...
namespace Eco.Mods.TechTree
{
    ...
    public partial class GeologyResearchPaperModernRecipe :
        RecipeFamily
    {
        public GeologyResearchPaperModernRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(1000, typeof(PotterySkill), typeof(GeologyResearchPaperModernRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(1);
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Geology Research Paper Modern"), typeof(GeologyResearchPaperModernRecipe));
