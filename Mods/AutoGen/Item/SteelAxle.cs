...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelAxleRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(100, typeof(IndustrySkill), typeof(SteelAxleRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelAxleRecipe), this.UILink(), 1.5f, typeof(IndustrySkill), typeof(IndustryFocusedSpeedTalent), typeof(IndustryParallelSpeedTalent));     
