...
namespace Eco.Mods.TechTree
{
    ...
    public partial class EngineeringResearchPaperModernRecipe :
        RecipeFamily
    {
        public EngineeringResearchPaperModernRecipe()
        {
            ...
            {
                new Recipe(
                    "EngineeringResearchPaperModern",
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(1000, typeof(MechanicsSkill), typeof(EngineeringResearchPaperModernRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(1);
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Engineering Research Paper Modern"), typeof(EngineeringResearchPaperModernRecipe));
