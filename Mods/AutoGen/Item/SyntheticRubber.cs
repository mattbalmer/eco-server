...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SyntheticRubberRecipe :
        RecipeFamily
    {
        public SyntheticRubberRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    "SyntheticRubber",
                    Localizer.DoStr("Synthetic Rubber"),
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(300, typeof(OilDrillingSkill), typeof(SyntheticRubberRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SyntheticRubberRecipe), this.UILink(), 1.6f, typeof(OilDrillingSkill), typeof(OilDrillingFocusedSpeedTalent), typeof(OilDrillingParallelSpeedTalent));     
