...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SoilSamplerRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(50, typeof(FertilizersSkill), typeof(SoilSamplerRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SoilSamplerRecipe), this.UILink(), 4, typeof(FertilizersSkill), typeof(FertilizersFocusedSpeedTalent), typeof(FertilizersParallelSpeedTalent));     
