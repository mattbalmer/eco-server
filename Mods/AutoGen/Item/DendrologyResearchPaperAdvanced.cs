...
namespace Eco.Mods.TechTree
{
    ...
    public partial class DendrologyResearchPaperAdvancedRecipe :
        RecipeFamily
    {
        public DendrologyResearchPaperAdvancedRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(200, typeof(CarpentrySkill), typeof(DendrologyResearchPaperAdvancedRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(1);
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Dendrology Research Paper Advanced"), typeof(DendrologyResearchPaperAdvancedRecipe));
