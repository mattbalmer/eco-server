...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public IronAxeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(SmeltingSkill), typeof(IronAxeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(IronAxeRecipe), this.UILink(), 0.5f, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Iron Axe"), typeof(IronAxeRecipe));
    ...
    {
        // Static values
        private static IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(IronAxeItem), typeof(LoggingToolEfficiencyTalent)), CreateCalorieValue(17, typeof(LoggingSkill), typeof(IronAxeItem), new IronAxeItem().UILink()));
