...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ModernPickaxeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(ModernPickaxeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ModernPickaxeRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Modern Pickaxe"), typeof(ModernPickaxeRecipe));
    ...
    {
        // Static values
        private static IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(ModernPickaxeItem), typeof(MiningToolEfficiencyTalent)), CreateCalorieValue(10, typeof(MiningSkill), typeof(ModernPickaxeItem), new ModernPickaxeItem().UILink()));
