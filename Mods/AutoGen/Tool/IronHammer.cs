...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public IronHammerRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(IronHammerRecipe), 0.5f, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));    
    ...
    {
        // Static values
        private static IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(IronHammerItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(8, typeof(SelfImprovementSkill), typeof(IronHammerItem), new IronHammerItem().UILink()));
