...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public IronHammerRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(SmeltingSkill), typeof(IronHammerRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(IronHammerRecipe), this.UILink(), 0.5f, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Iron Hammer"), typeof(IronHammerRecipe));
    ...
    {
        // Static values
        private static IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(IronHammerItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(17, typeof(SelfImprovementSkill), typeof(IronHammerItem), new IronHammerItem().UILink()));
