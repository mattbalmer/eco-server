...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public IronShovelRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(SmeltingSkill), typeof(IronShovelRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(IronShovelRecipe), this.UILink(), 0.5f, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Iron Shovel"), typeof(IronShovelRecipe));
