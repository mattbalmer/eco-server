...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelRoadToolRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(25, typeof(BasicEngineeringSkill), typeof(SteelRoadToolRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelRoadToolRecipe), this.UILink(), 0.5f, typeof(BasicEngineeringSkill), typeof(BasicEngineeringFocusedSpeedTalent), typeof(BasicEngineeringParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Steel Road Tool"), typeof(SteelRoadToolRecipe));
