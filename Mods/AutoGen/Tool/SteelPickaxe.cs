...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelPickaxeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(SteelPickaxeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelPickaxeRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Steel Pickaxe"), typeof(SteelPickaxeRecipe));
