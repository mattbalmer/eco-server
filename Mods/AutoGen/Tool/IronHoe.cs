...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public IronHoeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(SmeltingSkill), typeof(IronHoeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(IronHoeRecipe), this.UILink(), 0.5f, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Iron Hoe"), typeof(IronHoeRecipe));
    ...
    {
        // Static values
        private static IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(IronHoeItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(17, typeof(FarmingSkill), typeof(IronHoeItem), new IronHoeItem().UILink()));
