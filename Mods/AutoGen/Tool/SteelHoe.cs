...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelHoeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(SteelHoeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelHoeRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Steel Hoe"), typeof(SteelHoeRecipe));
