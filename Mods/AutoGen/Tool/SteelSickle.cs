...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelSickleRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(SteelSickleRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelSickleRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Steel Sickle"), typeof(SteelSickleRecipe));
