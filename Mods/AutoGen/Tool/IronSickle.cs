...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public IronSickleRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(SmeltingSkill), typeof(IronSickleRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(IronSickleRecipe), this.UILink(), 0.5f, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Iron Sickle"), typeof(IronSickleRecipe));
