...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public IronMacheteRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(SmeltingSkill), typeof(IronMacheteRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(IronMacheteRecipe), this.UILink(), 0.5f, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Iron Machete"), typeof(IronMacheteRecipe));
