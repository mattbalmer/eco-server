...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public IronRockDrillRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(SmeltingSkill), typeof(IronRockDrillRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(IronRockDrillRecipe), this.UILink(), 0.5f, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Iron Rock Drill"), typeof(IronRockDrillRecipe));
