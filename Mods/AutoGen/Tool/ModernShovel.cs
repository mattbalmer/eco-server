...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ModernShovelRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(ModernShovelRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ModernShovelRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Modern Shovel"), typeof(ModernShovelRecipe));
