...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelAxeRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(SteelAxeRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelAxeRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Steel Axe"), typeof(SteelAxeRecipe));
