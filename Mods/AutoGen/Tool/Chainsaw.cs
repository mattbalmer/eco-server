...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ChainsawRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(ChainsawRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ChainsawRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Chainsaw"), typeof(ChainsawRecipe));
