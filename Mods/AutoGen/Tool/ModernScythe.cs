...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ModernScytheRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(ModernScytheRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(ModernScytheRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Modern Scythe"), typeof(ModernScytheRecipe));
