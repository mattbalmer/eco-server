...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelMacheteRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(SteelMacheteRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelMacheteRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Steel Machete"), typeof(SteelMacheteRecipe));
    ...
    {
        // Static values
        private static IDynamicValue caloriesBurn = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(SteelMacheteItem), typeof(GatheringToolEfficiencyTalent)), CreateCalorieValue(15, typeof(GatheringSkill), typeof(SteelMacheteItem), new SteelMacheteItem().UILink()));
