...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public StoneRoadToolRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(10, typeof(BasicEngineeringSkill), typeof(StoneRoadToolRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(StoneRoadToolRecipe), this.UILink(), 0.5f, typeof(BasicEngineeringSkill), typeof(BasicEngineeringFocusedSpeedTalent), typeof(BasicEngineeringParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Stone Road Tool"), typeof(StoneRoadToolRecipe));
