...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public SteelShovelRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(SteelShovelRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelShovelRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Steel Shovel"), typeof(SteelShovelRecipe));
