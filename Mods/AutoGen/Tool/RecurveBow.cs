...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public RecurveBowRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(AdvancedSmeltingSkill), typeof(RecurveBowRecipe), this.UILink()); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(RecurveBowRecipe), this.UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
            this.Initialize(Localizer.DoStr("Recurve Bow"), typeof(RecurveBowRecipe));
