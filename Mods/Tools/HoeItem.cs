...
public class HoeItem : ToolItem
{
    ...
    public override LocString                  DescribeBlockAction   => Localizer.DoStr("plow a block");
    ...
    public override InteractResult OnActLeft(InteractionContext context)
    {
        ...
        if (context.HasBlock && context.Block!.Is<Tillable>()) return (InteractResult)AtomicActions.ChangeBlockNow(this.CreateMultiblockContext(context, () => new PlowField()), typeof(TilledDirtBlock));
