...
namespace Eco.Mods.WorldLayers
{
    ...
    public class SpeciesHabitabilityLayerSettingsCoyoteCapacity : SpeciesHabitabilityLayerSettings
    {
        ...
        {
            this.Species = "Coyote";
            this.HabitabilityComponents.Add( new ConsumerComponent() { CalorieConsumption = 200, Prey = new List<Type> {typeof(AnimalLayerSettingsHare), typeof(AnimalLayerSettingsBighornSheep), typeof(AnimalLayerSettingsTortoise)} } );
            this.Name = "CoyoteCapacity";
            this.DisplayName = Localizer.DoStr("Coyote Capacity");
